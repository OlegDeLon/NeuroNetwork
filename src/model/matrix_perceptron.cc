...
// //________________PrintMatrixPerceptron_________________//
// void MatrixPerceptron::PrintPerceptron() {
...
//             << "\n";
//   PrintLayer(count_hidden_layers_ + 1);

//   std::cout << "\n";
// }

// void MatrixPerceptron::PrintLayer(int layer) {
//   std::cout << "  Количество нейронов    " << value_[layer].size() << "\n";
//   std::cout << "\n";

//   for (size_t i = 0; i < value_[layer].size();
//        i++) {  // Сколько нейронов вывести
//     std::cout << "    Нейрон [" << i + 1 << "]: "
//               << "\n";
//     PrintNeuron(layer, i);
//   }
...
// void MatrixPerceptron::PrintNeuron(int layer, int neuron) {
//   std::cout << "      Значение :     " << value_[layer][neuron]
//             << "\n";  // Значения

//   std::cout << "      Ошибка :       " << error_[layer][neuron]
//             << "\n";  // Значения

//   std::cout << "      Дельта весов : " << delta_weight_[layer][neuron]
//             << "\n";  // Значения

//   if (layer != 0) {
//     std::cout << "      (Весов : " << weight_[layer][neuron].size()
//               << ") {\n";  // Веса
//     std::cout << "                    ";

//     for (size_t i = 0; i < weight_[layer][neuron].size() / 20; i++) {
//       // for (int i = 0; i < count_weight_; i++) {
//       std::cout << weight_[layer][neuron][i] << " ";
//     }
//   }
//   std::cout << "\n                    }"
//             << "\n";
